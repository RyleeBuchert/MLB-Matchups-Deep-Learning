...
def get_pitcher_gamelogs(player_id):
    ...
    for year in [2014,2015,2016,2017,2018,2019,2020,2021]:
        ...
        if pitching_log:
            ...
            for game in pitching_log:
                ...
                for i in [10,14,12,38,39,40,41,42,15,16,17,18,21,26,27,28,29]:
                    try:
                        game_record.append(int(game.contents[i].contents[0]))
                    except IndexError:
                        game_record.append(0)
            ...
            cols = ['date','team','side','opp','IP','days_rest','ER','H','2B','3B','IBB',
    ...
    pitching_log_data = pitching_log_data[['game_code','date','team','side','opp','PA','IP','ER','H','2B','3B','HR',
